    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" style={{color:"#64ffda"}} to="/home">Home</Link>
        </li>
        <li className="nav-item">
      ...
      <Link className="btn mx-1" style={{color:"#64ffda" , background:"#0a192f"}} to="/signup">Signup</Link>
    </div>
  </div>
</nav>
        </div>
